				  ...
				  eTipo *listaT, int tamT, int *flagAdd)
{
	...
	if (lista != NULL && tamM > 0 && listaC != NULL && tamC > 0 && listaT != NULL && tamT > 0)
	{
		...
		system("cls");
			...
			printf("%-4s  %-20s %-8s %-8s %-3s  %-1s %-15s\n", "ID", "NOMBRE", "TIPO", "COLOR", "EDAD", "VACUNACION", "DUEÑO");
			printf("---------------------------------------------------------\n");
...
int hardCodearMascotas(eMascota *lista)
{
	...
	if (lista != NULL)
	{
		eMascota mascotass[22] = {
			...
			{2, "DFR234", {2,"Claudio", 'm'},1003, 5000, 10, 's', 0},
			{3, "GFT564", {3,"Roberto", 'm'},1002, 5003, 2, 'n', 0},
			{4, "ACD321", {4,"Juan", 'm'},1002, 5003, 3, 's', 0},
			{5, "HTD656", {5,"Pedro", 'm'},1004, 5002, 15, 's', 0},
			{6, "QSZ435", {6,"Gabriel", 'm'},1003, 5001, 9, 's', 0},
			{7, "LGX201",{7,"Nicolas", 'm'}, 1001, 5000, 1, 'n', 0},
			{8, "SUZ324", {8,"Sandra", 'f'},1001, 5002, 11, 's', 0},
			{9, "HCU762", {9,"Florencia", 'f'},1000, 5003, 6, 's', 0},
			{10, "DYC735",{10,"Juana", 'f'}, 1003, 5001, 8, 'n', 0},
			{11, "JJK879",{10,"Juana", 'f'}, 1003, 5001, 1, 's', 0},
			{12, "FED322",{9,"Florencia", 'f'}, 1004, 5002, 3, 'n', 0},
			{13, "GHV332",{11,"Jose", 'm'}, 1001, 5003, 15, 's', 0},
			{14, "BDE221", {12,"Sergio", 'm'},1000, 5004, 1, 'n', 0},
			{15, "OPD332",{13,"Tomas", 'm'}, 1000, 5001, 8, 's', 0},
			{16, "PPD121",{14,"Gloria", 'f'}, 1002, 5001, 1, 'n', 0},
			{17, "IIT230",{15,"Micaela", 'f'}, 1001, 5000, 9, 'n', 0},
			{18, "KOD220",{16,"Mariana", 'f'}, 1004, 5002, 15, 's', 0},
			{19, "QSZ305", {17,"Rocio", 'f'},1004, 5002, 1, 'n', 0},
			{20, "SSD128", {18,"Javier", 'm'},1002, 5003, 14, 'n', 0},
			{21, "SSD240",{19,"Santiago", 'm'}, 1003, 5004, 13, 'n', 0},
			{22, "EDF213",{20,"Florencia", 'f'}, 1001, 5000, 12, 'n', 0}};
