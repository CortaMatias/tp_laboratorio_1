	...
	if (initStruct(listaM, TAMM) && initStructTrabajo(listaTra, TAMTRABAJO))
	{
		do
		{
			...
			case 12:
				...
				informes(listaTra, TAMTRABAJO, listaM, TAMM, listaS,
						   TAMS, &idTrabajo, listaC, TAMC, listaT, TAMTIPO);
				}else{
			...
			case 13:
				...
				mostrarVacunados(listaM, TAMM, listaT, TAMTIPO, listaC, TAMC, listaTra, TAMTRABAJO, listaS, TAMS);
				mostrarNoVacunados(listaM, TAMM, listaT, TAMTIPO, listaC, TAMC, listaTra, TAMTRABAJO, listaS, TAMS);
