...
int controller_addPassenger(LinkedList *pArrayListPassenger) {
	...
	if (pArrayListPassenger != NULL) {
		...
		while (strcmp(tipoPasajero, "Firstclass") != 0
				&& strcmp(tipoPasajero, "Executiveclass") != 0
				&& strcmp(tipoPasajero, "Economicclass") != 0) {
			validarTexto(
					"\n** Error. ReIngrese el tipo de pasajero:  FirstClass o ExecutiveClass o EconomicClass **  \n",
					"\n** Error. ReIngrese el tipo de pasajero:  FirstClass o ExecutiveClass o EconomicClass ** \n",
					tipoPasajero, 50);
		...
		validarTexto(
				"\n** Ingrese el estado del vuelo:  En horario o Demorado o Aterrizado ** \n",
				"\n** Error. ReIngrese el estado del vuelo:  En horario o Demorado o Aterrizado ** \n",
				estadoDeVuelo, 50);
		ordenarStrings(estadoDeVuelo);

		while (strcmp(estadoDeVuelo, "En horario") != 0
				&& strcmp(estadoDeVuelo, "Demorado") != 0
				&& strcmp(estadoDeVuelo, "Aterrizado") != 0) {
			validarTexto(
					"\n** Ingrese el estado del vuelo:  En horario o Demorado o Aterrizado ** \n",
					"\n** Error. ReIngrese el estado del vuelo:  En horario o Demorado o Aterrizado ** \n",
					estadoDeVuelo, 50);
						...
						do {
							...
							case 5:
								...
								while (strcmp(tipoPasajero, "Firstclass") != 0
										&& strcmp(tipoPasajero,
												"Executiveclass") != 0
										&& strcmp(tipoPasajero, "Economicclass")
												!= 0) {
									validarTexto(
											"\n** Error. ReIngrese el tipo de pasajero:  FirstClass o ExecutiveClass o EconomicClass **  \n",
											"\n** Error. ReIngrese el tipo de pasajero:  FirstClass o ExecutiveClass o EconomicClass ** \n",
							...
							case 6:
								...
								while (strcmp(estadoDeVuelo, "En horario") != 0
										&& strcmp(estadoDeVuelo, "Demorado")
												!= 0
										&& strcmp(estadoDeVuelo, "Aterrizado")
												!= 0) {
									validarTexto(
											"\n** Error. ReIngrese el estado del vuelo:  En horario o Demorado o Aterrizado **  \n",
											"\n** Error. ReIngrese el estado del vuelo:  En horario o Demorado o Aterrizado ** \n",
...
int controller_SortPrecio(void *pasajero1, void *pasajero2) {
	...
	if (pasajero1 != NULL && pasajero2 != NULL) {
		...
		if (((Passenger*) pasajero1)->precio
				> ((Passenger*) pasajero2)->precio) {
			return 1;
		}
		if (((Passenger*) pasajero1)->precio
				< ((Passenger*) pasajero2)->precio) {
